function makeStory() {
    ...
    var message = "In 1981, the U.S. launched the first real Space " + noun1 + ". It was named Columbia and was piloted by two brave " + plural_noun1 + ". They had practiced " + ing_verb1 + " for two years and were expert " + plural_noun2 + ". Columbia took off from " + city1 + " using its powerful first-stage " + plural_noun3 + " and soared off into the " + adjective1 + " blue " + noun2 + ". At an altitude of " + number1 + " feet, it went into orbit around the " + noun3 + ". For people watching from Earth, it was a/an " + adjective2 + " sight to " + verb1 + "!";
    var message2 = "Who could really " + verb2 + " that there were two " + plural_noun4 + " in space? It was mind " + ing_verb2 + ". After " + number2 + " orbits, the shuttle landed " + adverb1 + " at an air force " + noun4 + ". It was a/an " + adjective3 + " day for the U.S. Space Program.";
